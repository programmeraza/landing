          ...
          <div className="work__wrapper">
            <div className="work__title">
              <div className="work__block">
                ...
                <p>Работает за вас 24/7</p>
              </div>
              <h1>Автоматизация - главное в нас</h1>
            </div>
            <div className="work__cards">
                <div className="work__card">
                    <div className="work__content">
                        <h2>Публикация вакансий и <br /> получение откликов</h2>
                        <p>Размещайте вакансии напрямую на HeadHunter, IshGo и в Telegram-ботах. Все отклики поступают автоматически, а нерелевантные резюме не перегружают вашу базу.</p>
                        <button className="work__btn">Подробнее</button>
                    </div>
                ...
                <div className="work__card">
                    ...
                    <div className="work__content">
                        <h2>Умное планирование <br /> интервью</h2>
                        <p>Отправляйте приглашения кандидатам и коллегам напрямую в календарь. Система автоматически проверит занятость, прикрепит резюме и вакансию, забронирует переговорную и создаст ссылку для онлайн-встречи.</p>
                        <button className="work__btn">Подробнее</button>
                    </div>
                </div>
                <div className="work__card">
                    <div className="work__content">
                        <h2>Общение с кандидатами</h2>
                        <p>Переписка по e-mail и в чате HeadHunter в одном окне. История сообщений автоматически сохраняется в карточке кандидата.</p>
                        <button className="work__btn">Подробнее</button>
                    </div>
                    <img src="./card1.png" alt="" />
                </div>
